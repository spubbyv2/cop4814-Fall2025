...
class QuizForm(FlaskForm):
    ...
    submit = SubmitField("Get to my House")
...
def index():
    ...
    if form.validate_on_submit():
        ...
        return render_template("harry.html", form=form, house=HOUSES[chosen_key])
    return render_template("harry.html", form=form, house=None)
